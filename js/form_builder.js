$(document).ready(function() {
  ...
  function getPreview(plain_html = "") {
    ...
    el.each(function() {
      ...
      var label = $(this)
        ...
        .val();
      var name = $(this)
        .find(".form_input_name")
        .val();
      if (data_type === "text") {
        var placeholder = $(this)
          .find(".form_input_placeholder")
          .val();
      ...
      if (data_type === "button") {
        var btn_class = $(this)
          .find(".form_input_button_class")
          .val();
        var btn_value = $(this)
          .find(".form_input_button_value")
          .val();
        html +=
          '<button name="' +
          name +
  ...
  $(document).on("click", ".export_html", function() {
    var html = getPreview("html");
    var fname = $("#save_html").attr("fname");
    var filename = $("#save_html").attr("filename");
    var fields = $(".preview").find("input");
    var arr = [];
